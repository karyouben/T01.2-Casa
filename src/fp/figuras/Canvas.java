...
public class Canvas
{
     ...
     * Este método también puede usarse para traer al primer plano a un canvas visible
    ...
    /**
     * Espera un número especificado de milisegundos antes de acabar.
     * Proporciona una forma fácil de espercificar un pequeño retraso que
     ...
     * Es esencialmente un JPanel con una capacidad añadida para refrescar 
     * la imagen en él.
     */
